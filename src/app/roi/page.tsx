...
import { SimpleBarChart, SimpleLineChart, SimplePieChart } from "@/app/frontEnd/ui/components/charts/SimpleCharts";
...
export default function RoiPage() {
  return (
    <>
      <h3 className="section-header">ROI & Economics</h3>
      <p className="panel-subtle" style={{ marginTop: "-0.35rem", marginBottom: "1rem" }}>
        High-level return, payback, and cost stack. Wire your sizing + tariff model here later.
      </p>
